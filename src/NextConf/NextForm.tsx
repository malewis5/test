...
import css from './nextform.scss'

const HUBSPOT_PORTAL_ID = '4072931'
const HUBSPOT_BURGER_MENU_FORM_ID = 'a22e72f5-1beb-4145-b630-50ba1c443da7'
...
export const NextForm: React.FC<IHubspotCustomSubscribeFormsProps> = ({ className }) => {
